...
describe('WizardsContainer', ()=>{
  ...
  it('Should render Wizard components with the given state', ()=>{
    wrapper.setState({
      wizards: [
        {name: 'Ian', id: 1, description: 'A description', avg_rating: 83, imgUrl: 'www.wizard.com'},
    ...
    expect(wrapper.find(WizardTile).at(0).props()).toEqual({name: 'Ian', id: 1, description: "A description", imgUrl: undefined, avg_rating: undefined})
